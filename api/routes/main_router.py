...
class MainRouterResponse(BaseModel):
    """
    Modèle structuré pour la réponse du routeur principal
    """
...
async def route_and_process_request(
    ...
    Returns:
        MainRouterResponse: Réponse structurée du traitement de la requête
    """
    try:
